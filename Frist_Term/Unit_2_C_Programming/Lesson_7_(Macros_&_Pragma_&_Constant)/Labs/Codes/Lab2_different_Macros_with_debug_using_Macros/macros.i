...
void CAN_init()
{
 if (3>1) printf ("@ Function : %s , File : %s , Line : %d",__func__,".\\macros.c",15); printf ("\t>> "); printf ("...\n");;
 printf("sum is : %d\n",5 +6);
...
{
 int x=12;
 if (3>1) printf ("@ Function : %s , File : %s , Line : %d",__func__,".\\macros.c",22); printf ("\t>> "); printf ("...\n");;
 printf("example 4 = %d\n",x);
}

int main()
{
 if (2>1) printf ("@ Function : %s , File : %s , Line : %d",__func__,".\\macros.c",28); printf ("\t>> "); printf ("Start Main \n");;
 printf("example1 = %d\n",10);
 printf("salah soliman \n");
 CAN_init();
 CAN_Send();
 if (2>1) printf ("@ Function : %s , File : %s , Line : %d",__func__,".\\macros.c",33); printf ("\t>> "); printf ("End Main \n");;
 return 0;
}
